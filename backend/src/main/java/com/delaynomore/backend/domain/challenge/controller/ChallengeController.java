...
/**
 * Goal Challenge API — 정원이 한정된 목표 챌린지의 개설·조회·참가.
 *
...
public class ChallengeController {
    ...
    @PostMapping
    public ApiResponse<ChallengeResponse> create(@Valid @RequestBody ChallengeCreateRequest request,
                                                 @Owner String owner) {
        log.info("Received request to create challenge");
        return ApiResponse.ok(challengeService.create(request, owner));
    }
