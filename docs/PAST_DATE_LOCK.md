...
> **핵심 한 줄: 잠금은 계획의 날짜가 아니라 계획의 "상태"가 결정합니다 — "고정" 버튼을 누른 순간부터 지난 날짜가 잠깁니다.** (v0.14.2)
...
지난 날짜(예: 이틀 전 Day 카드)가 체크된다면, 그 계획은 아직 **DRAFT**인 것입니다. 버그가 아니라 위 표 그대로의 동작입니다.
