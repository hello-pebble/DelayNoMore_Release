...
> [DelayNoMore](https://github.com/hello-pebble/DelayNoMore)의 **"대화를 통해 투두리스트(하루 단위 실행 계획)를 생성하는"** 핵심 흐름만 떼어낸 최소 배포판입니다. 현재 버전: **v0.6.0**
...
| 문서 | 내용 |
| :--- | :--- |
| [기능 상세](docs/FEATURES.md) | 화면 구성과 8가지 기능의 상세 동작 |
