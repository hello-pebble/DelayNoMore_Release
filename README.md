...
(현재 HTTP로 서비스 중이며, 로그인 연동 마무리 후 HTTPS를 적용할 예정입니다. DB 영속화는 v0.12.0에서 적용됐습니다.)

> [DelayNoMore](https://github.com/hello-pebble/DelayNoMore)의 **"대화를 통해 투두리스트(하루 단위 실행 계획)를 생성하는"** 핵심 흐름만 떼어낸 최소 배포판입니다. 현재 버전: **v0.13.1**
