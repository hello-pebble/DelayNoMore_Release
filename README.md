...
graph TD
    ...
    FINAL(["🎯 최종 목표 · 전문 에이전트 인계<br/>계획을 고정하면 컨설턴트 대신<br/>목표 영역의 전문 에이전트가 실행을 전담<br/>(자격증 → 1:1 과외 · 다이어트 → 코치)"])
...
계획을 만드는 동안은 지금처럼 AI 코치(계획 컨설턴트)가 함께하지만, 계획을 고정한 뒤에는 컨설턴트가 아니라 **목표 영역에 특화된 전문 에이전트**가 붙어 실행을 최종 마무리합니다.
